...
const createMenu = () => {
  navSelection();
  // create cookies
  const chocolateChip = Card(
    "Chocolate Chip",
    "../src/chocolate-chip.jpg",
    "$1.50"
  );
  const chocolateExplosion = Card(
    "Chocolate Explosion",
    "../src/double-chocolate-cookies.jpg",
    "$1.50"
  );
  const chewyOatmeal = Card(
    "Chewy Oatmeal",
    "../src/oatmeal-cookie.png",
    "$1.50"
  );
  const snickerdoodle = Card(
    "Snickerdoodle",
    "../src/snickerdoodle-cookies.jpg",
    "$1.50"
  );
  const smores = Card("Gooey Smores", "../src/smores.png", "$2.50");
  const peanutButter = Card(
    "Peanut Butter",
